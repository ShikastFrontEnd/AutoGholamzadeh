       ...
       <div className="absolute bottom-0 flex items-center justify-center w-full">
           ...
           <div className="w-full space-y-4 p-3 md:p-0">
            <div className="flex justify-between border-b-2 pb-4 border-gray-100">
                <div className="w-full text-center text-xl flex text-gray-100 "><span className="pe-1">تومان</span><span>{PN.convertEnToPe(formatNumberWithDots(condition.price))}</span></div>
            ...
            <>
                <div className="flex justify-between">
                    ...
                    <div className="w-full text-center text-base text-gray-100 flex justify-end">شرایط اقساط</div>
                </div>
                <div className="flex justify-between">
                    <div className="w-full text-center text-base text-gray-100 flex justify-start">{condition.percentage}%</div>
                    <div className="w-full text-center text-base text-gray-100 flex justify-end">درصد اقساط</div>
                </div>
                <div className="flex justify-between">
                    <div className="w-full text-center text-base flex justify-start text-gray-100">
                        <span className="pe-1">تومان</span>
                        <span>{PN.convertEnToPe(formatNumberWithDots(condition.advance))}</span>
                    </div>
                    <div className="w-full text-center text-base text-gray-100 flex justify-end">پیش پرداخت</div>
                </div>
                    ...
                    <div className="flex justify-between">
                        ...
                        <div className="w-full text-center text-base flex text-gray-100 justify-end">
